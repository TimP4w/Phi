...
type FluxApplicationsProps = object;

const FluxApplicationsCard: React.FC<FluxApplicationsProps> = observer(
  (_: FluxApplicationsProps) => {
    ...
    return (
      <Card className="max-w-[250px] max-h-[250px] overflow-x-visible relative">
        <CardHeader className="flex gap-3">
          <div className="flex flex-col">
            <p className="text-md">Applications Status</p>
          </div>
        </CardHeader>
        <CardBody className="z-999">
          <VictoryPie
...
export default FluxApplicationsCard;
