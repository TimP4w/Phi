...
function MiddlewareWallNode({ data }: NodeProps<Node<NetworkNodeData>>) {
  ...
  return (
    <div className="relative">
      ...
      <div className="w-[240px] bg-content2 border-l-4 border-default-400 border-y border-r border-default-200 rounded-md shadow-sm">
        <div className="flex items-center gap-2 px-3 pt-2 pb-1.5">
          <BrickWall className="w-4 h-4 flex-shrink-0 text-default-500" />
