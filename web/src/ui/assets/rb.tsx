...
const SvgRb = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    />
    <path
      d="M7.107 9.255c0-.66.537-1.197 1.197-1.197H9.85v-.734H8.304a1.932 1.932 0 0 0 0 3.862H9.85v-.733H8.304c-.66 0-1.197-.537-1.197-1.198m1.584.387h3.09v-.773H8.69zm3.475-2.318h-1.544v.734h1.544a1.198 1.198 0 0 1 0 2.395h-1.544v.733h1.544a1.932 1.932 0 0 0 0-3.862"
      style={{
        fill: "#fff",
        fillOpacity: 1,
