...
const SvgSa = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    />
    <path
      d="M10.011 4.985 5.97 6.78v2.695c0 2.491 1.724 4.822 4.041 5.388 2.317-.566 4.04-2.897 4.04-5.388V6.78zm0 1.903a1.293 1.293 0 1 1-.001 2.589 1.293 1.293 0 0 1 .001-2.59m2.423 5.347q0 .05-.027.09-.043.068-.09.132a4.5 4.5 0 0 1-2.306 1.654 4.5 4.5 0 0 1-2.307-1.654q-.047-.064-.09-.131a.17.17 0 0 1-.028-.09v-.718c0-.991 1.617-1.491 2.425-1.491s2.423.5 2.423 1.49z"
      pointerEvents="none"
      style={{
        fill: "#fff",
        fillOpacity: 1,
