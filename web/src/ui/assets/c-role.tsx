const SvgCRole = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <path
      ...
      transform="matrix(1.01489 0 0 1.01489 15.91 -3.873)"
    />
    <g pointerEvents="none" transform="translate(-.993 -.893)">
      <ellipse
        cx={9.928}
        cy={9.949}
        rx={0.506}
      ...
      />
      <path
        d="M10.01 5.876 6.904 7.25V9.3c0 1.902 1.325 3.679 3.108 4.11 1.78-.431 3.107-2.208 3.107-4.11V7.25zm1.646 5.518H8.364V8.631h.473v-.302c0-.65.532-1.179 1.19-1.179.656 0 1.188.528 1.188 1.18v.3h.441z"
        style={{
          fill: "#fff",
          fillOpacity: 1,
          stroke: "none",
