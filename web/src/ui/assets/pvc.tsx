...
const SvgPvc = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    />
    <path
      d="M14.64 8.403c0 .621-2.073 1.125-4.63 1.125s-4.629-.504-4.629-1.125c0-.62 2.073-1.124 4.63-1.124s4.628.503 4.628 1.124v3.043c0 .62-2.072 1.124-4.629 1.124s-4.629-.503-4.629-1.124V8.403"
      style={{
        fill: "none",
        fillRule: "evenodd",
        stroke: "#fff",
