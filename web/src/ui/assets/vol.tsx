...
const SvgVol = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    />
    <path
      d="M5.571 8.193c0 .62 2.073 1.124 4.63 1.124s4.628-.503 4.628-1.124v3.042c0 .621-2.072 1.125-4.629 1.125s-4.629-.504-4.629-1.125z"
      style={{
        fill: "#fff",
        fillRule: "evenodd",
        stroke: "none",
    ...
    />
    <path
      d="M5.571 8.193c0-.621 2.073-1.125 4.63-1.125s4.628.504 4.628 1.125c0 .62-2.072 1.124-4.629 1.124s-4.629-.503-4.629-1.124"
      style={{
        fill: "#fff",
        fillOpacity: 1,
        fillRule: "evenodd",
    ...
    />
    <path
      d="M14.83 8.193c0 .62-2.073 1.124-4.63 1.124s-4.629-.503-4.629-1.124 2.073-1.125 4.63-1.125 4.628.504 4.628 1.125v3.042c0 .621-2.072 1.125-4.629 1.125s-4.629-.504-4.629-1.125V8.193"
      style={{
        fill: "none",
        fillRule: "evenodd",
        stroke: "#326ce5",
