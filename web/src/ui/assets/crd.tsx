...
const SvgCrd = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    />
    <path
      d="M14.27 9.693h-.693V7.846a.926.926 0 0 0-.924-.924h-1.847V6.23a1.155 1.155 0 0 0-2.31 0v.692H6.65a.92.92 0 0 0-.92.924v1.755h.69a1.248 1.248 0 0 1 0 2.494h-.694v1.755c0 .508.416.924.924.924h1.755v-.693a1.248 1.248 0 0 1 2.494 0v.693h1.755a.926.926 0 0 0 .924-.924v-1.847h.693a1.155 1.155 0 0 0 0-2.31"
      style={{
        fill: "#fff",
        fillOpacity: 1,
        strokeWidth: 0.46185368,
      }}
      transform="translate(-.993 -1.174)"
    />
  </svg>
);
export default SvgCrd;
