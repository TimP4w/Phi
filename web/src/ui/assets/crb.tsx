const SvgCrb = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    />
    <path
      d="M6.882 9.924c0-.66.537-1.197 1.197-1.197h1.545v-.734H8.08a1.932 1.932 0 0 0 0 3.862h1.545v-.733H8.08c-.66 0-1.197-.537-1.197-1.198m1.584.387h3.09v-.773h-3.09zm3.475-2.318h-1.545v.734h1.545a1.198 1.198 0 0 1 0 2.395h-1.545v.733h1.545a1.932 1.932 0 0 0 0-3.862"
      style={{
        fill: "#fff",
        fillOpacity: 1,
