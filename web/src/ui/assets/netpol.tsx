...
const SvgNetpol = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    />
    <path
      d="M9.49 5.352a4.193 4.193 0 0 0-4.192 4.19 4.193 4.193 0 0 0 4.191 4.192 4.2 4.2 0 0 0 1.473-.271v-.988c0-.336.275-.9.61-.9v-.916c0-.46.685-1.237 1.528-1.237.206 0 .401.042.58.116a4.193 4.193 0 0 0-4.19-4.186m.837 1.466 1.467 1.467h-1.047v1.677h-.839V8.285H8.861zM8.232 9.123h.838V10.8h1.048L8.65 12.267 7.184 10.8h1.048zm4.974 1.04c-.599 0-1.084.486-1.084 1.084v.65a.434.434 0 0 0-.433.433v1.734c0 .239.194.433.433.433h2.167a.434.434 0 0 0 .433-.433V12.33a.434.434 0 0 0-.433-.433v-.65c0-.598-.485-1.084-1.083-1.084m0 .433c.36 0 .65.291.65.65v.65h-1.3v-.65c0-.359.29-.65.65-.65"
      style={{
        fill: "#fff",
        fillOpacity: 1,
        strokeWidth: 0.4190996,
      }}
      transform="translate(-.993 -1.174)"
    />
  </svg>
);
export default SvgNetpol;
