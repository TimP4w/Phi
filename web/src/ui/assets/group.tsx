...
const SvgGroup = (props: React.SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    />
    <path
      d="M6.166 5.424a.855.855 0 0 0-.856.856v7.288c0 .475.382.857.856.857h7.688a.855.855 0 0 0 .857-.857V6.28a.855.855 0 0 0-.857-.856zm2.591 2.308c.52 0 .937.42.937.94s-.417.939-.937.939a.938.938 0 1 1 0-1.88m2.506 0c.52 0 .937.42.937.94s-.417.939-.937.939a.938.938 0 1 1 0-1.88m-2.506 2.505c.73 0 2.193.367 2.193 1.097v.783H6.565v-.783c0-.73 1.463-1.097 2.192-1.097m2.506 0c.73 0 2.193.367 2.193 1.097v.783h-1.88v-.783c0-.464-.253-.818-.617-1.081q.166-.015.304-.016"
      style={{
        opacity: 1,
        fill: "#fff",
        fillOpacity: 1,
        fillRule: "nonzero",
        stroke: "none",
        strokeWidth: 0.20160896,
        strokeLinecap: "butt",
        strokeLinejoin: "round",
        strokeMiterlimit: 10,
        strokeDasharray: ".40321791,.20160896",
