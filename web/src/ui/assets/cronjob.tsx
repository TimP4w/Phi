...
const SvgCronjob = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    />
    <path
      d="M12.608 7.94a3.21 3.21 0 0 0-3.2 3.2c0 1.76 1.44 3.2 3.2 3.2s3.2-1.44 3.2-3.2-1.44-3.2-3.2-3.2m1.344 4.543-1.664-1.024V9.54h.48v1.664l1.44.864z"
      style={{
        fill: "#fff",
        fillOpacity: 1,
