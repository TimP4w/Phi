...
func (_m *PatchableResource) PatchType() kubernetes.PatchType {
	ret := _m.Called()
	...
	var r0 kubernetes.PatchType
	if rf, ok := ret.Get(0).(func() kubernetes.PatchType); ok {
		r0 = rf()
	} else {
		r0 = ret.Get(0).(kubernetes.PatchType)
	}
...
func (_c *PatchableResource_PatchType_Call) Return(_a0 kubernetes.PatchType) *PatchableResource_PatchType_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *PatchableResource_PatchType_Call) RunAndReturn(run func() kubernetes.PatchType) *PatchableResource_PatchType_Call {
	_c.Call.Return(run)
	return _c
}
