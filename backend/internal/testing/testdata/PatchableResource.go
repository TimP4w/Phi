...
func (_m *PatchableResource) PatchType() types.PatchType {
	ret := _m.Called()
	...
	if rf, ok := ret.Get(0).(func() types.PatchType); ok {
		r0 = rf()
	} else {
...
func (_c *PatchableResource_PatchType_Call) Return(_a0 types.PatchType) *PatchableResource_PatchType_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *PatchableResource_PatchType_Call) RunAndReturn(run func() types.PatchType) *PatchableResource_PatchType_Call {
	_c.Call.Return(run)
	return _c
}
